...
# image = Image.open('D:/Work/DISAVIT/labels/test_images/Picture44.jpg')


image_list = []

def image_to_mqtt():
    f=open("D:/Python_ex/pycharm/web4/asaved_leaf/leaf.jpg", "rb") #3.7kiB in same folder
    fileContent = f.read()
...
def message():
    for filename in glob.glob('D:/Python_ex/pycharm/web4/static/uploads/*.jpg'):
        ...
        if(disease != "Healthy"):
            im.save(r'D:/Python_ex/pycharm/web4/asaved_leaf/leaf.jpg')
            image_to_mqtt();
